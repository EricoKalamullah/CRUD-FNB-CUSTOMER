...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql="insert into daftar_pelanggan (nama_pembeli,paket_menu_ayam,jumlah_pesanan,no_meja,total_biaya) values
		('$nama_pembeli','$paket_menu_ayam','$jumlah_pesanan','$no_meja','$total_biaya')";
    ...
    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="paket_menu_ayam" class="form-control" placeholder="Masukan Menu Ayam" required/>
        </div>
       <div class="form-group">
            <label>Jumlah Pesanan :</label>
            <input type="text" name="jumlah_pesanan$jumlah_pesanan" class="form-control" placeholder="Masukan Jumlah Pesanan" required/>
        </div>
                </p>
        <div class="form-group">
            <label>No Meja :</label>
